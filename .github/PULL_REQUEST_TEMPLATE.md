...
- [ ] Platform Tested: [e.g., Windows 11, macOS, Linux]
...
- [ ] Original Ebta Setiawan's attribution is preserved (non-negotiable rule)
- [ ] License has not been modified (must be PolyForm Noncommercial 1.0.0)
